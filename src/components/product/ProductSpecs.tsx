...
export default function ProductSpecs({ product }: ProductSpecsProps) {
    ...
    return (
        <div className="bg-white rounded-xl border border-gray-200 p-5">
            <h3 className="font-bold text-lg mb-4 text-gray-900">At a Glance</h3>

            {/* Specs Grid */}
            <div className="grid grid-cols-2 gap-y-4 gap-x-8">
                {specs.map((spec, index) => (
                    <div key={index}>
                        <p className="text-xs text-gray-600 uppercase tracking-wider">{spec.label}</p>
            ...
            <div className="mt-6 pt-4 border-t border-dashed border-gray-200">
                <button className="w-full flex items-center justify-center gap-2 text-primary font-bold hover:underline">
