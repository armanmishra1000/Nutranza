                ...
                <div className="container">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 md:h-[600px] lg:h-[560px]">
                        ...
                        <div className="flex flex-col gap-6 h-full">
                            <div className="w-full aspect-4/3 md:aspect-auto flex-1 rounded-3xl overflow-hidden">
                                <img
                        ...
                        {/* Column 2 */}
                        <div className="h-full aspect-4/3 md:aspect-auto rounded-3xl overflow-hidden">
                            <img
